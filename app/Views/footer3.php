...
<script src="<?php echo base_url('template/vendor/slick/slick.min.js') ?>"></script>
<script src="<?php echo base_url('template/js/slick-custom.js') ?>"></script>

<script src="<?php echo base_url('template/vendor/parallax100/parallax100.js') ?>"></script>
<script>
    $('.parallax100').parallax100();
</script>

<script src="<?php echo base_url('template/vendor/MagnificPopup/jquery.magnific-popup.min.js') ?>"></script>
<script>
...
<script src="<?php echo base_url('template/vendor/isotope/isotope.pkgd.min.js') ?>"></script>

<script src="<?php echo base_url('template/vendor/sweetalert/sweetalert.min.js') ?>"></script>
<script>
